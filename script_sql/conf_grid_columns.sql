...
COMMENT ON COLUMN pacificosul.conf_grid_column.name_key IS 'Chave da coluna para linkar o response do backend com a coluna no frontend';
...
END pacificosul.conf_tr_grid_column;