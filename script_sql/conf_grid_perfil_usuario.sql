...
ALTER TABLE pacificosul.conf_grid_perfil_usuario
    ADD CONSTRAINT REF_GRID_GRID_PER_USER FOREIGN KEY(id_grid) REFERENCES PACIFICOSUL.conf_grid(ID);
ALTER TABLE pacificosul.conf_grid_perfil_usuario
...
ALTER TABLE pacificosul.conf_grid_perfil_usuario ADD CONSTRAINT UNIQ_USER_CONF_GRID_PERFIL UNIQUE(id_grid, id_usuario);
